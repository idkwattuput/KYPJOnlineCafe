...
const CafeFeed = () => {
    ...
    return (
        ...
        <div id="cafe" className='flex flex-col items-center justify-center p-4'>
            <h1 className='mt-2 mb-3 text-3xl font-bold text-center text-zinc-900'>List Of Cafe</h1>
            <div className="grid items-center justify-center  grid-cols-3 gap-4 max-w-2xl">
                {openCafes.map((cafe) => (
